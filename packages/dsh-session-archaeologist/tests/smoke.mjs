...
check('bundle registers __ModuleLoader__', handoff !== null && handoff.id === 'dsh-session-archaeologist')
...
// Provide a minimal fetch stub so the panel's status call is inert.
...
try {
  ...
  check('registered sidebar.footer.action slot', registrations.some((r) => r.slotName === 'sidebar.footer.action'))
} catch (error) {
