// Smoke test: load built lib/client.js in jsdom and verify the bundle registers
// under the __ModuleLoader__ contract and apply() mounts cleanly.
...
check('bundle registers __ModuleLoader__', handoff !== null && handoff.id === 'dsh-time-machine')
