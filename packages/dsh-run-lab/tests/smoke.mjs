...
check('bundle registers __ModuleLoader__', handoff !== null && handoff.id === 'dsh-run-lab')
...
try {
  ...
  check('registered sidebar footer action', registrations.some((r) => r.slotName === 'sidebar.footer.action' || r.spec?.name === 'sidebar.footer.action'))
} catch (error) {
