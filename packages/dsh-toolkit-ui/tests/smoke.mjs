// Smoke test: load built lib/client.js and verify shell registers header action.
...
check('bundle registers __ModuleLoader__', handoff !== null && handoff.id === 'dsh-toolkit-ui')
